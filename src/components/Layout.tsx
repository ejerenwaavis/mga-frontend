...
className="h-[500px] w-auto md:h-[400px]"  // 90% of original size
  ...
  return (
    ...
    >
      ...
      <div className="container py-12 md:py-16">
        {/* First Row: Logo only - Left Aligned with container padding */}
        ...
        {/* Second Row: Description, Quick Links, Resources, Contact - Even spacing */}
