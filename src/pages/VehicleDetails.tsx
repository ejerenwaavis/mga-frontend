...
export default function VehicleDetails() {
  ...
  return (
    <>
      {/* Main wrapper with dark green background */}
      <div className="bg-[#0a1a12]">
        {/* Back button section */}
        ...
        <section className="py-12 md:py-16">
          <div className="container">
            <div className="grid gap-12 lg:grid-cols-2">
              ...
              <FadeIn>
                <div className="space-y-3">
                  {/* Main display image */}
                  <div className="aspect-[4/3] rounded border border-border bg-white overflow-hidden group cursor-pointer">
                    {displayImage ? (
                      <img
                        src={displayImage}
                    ...
                    {gallerySlots.map((slot) => {
                      ...
                      return (
                        <div
                          ...
                          className={`aspect-[4/3] rounded border bg-white flex items-center justify-center overflow-hidden group cursor-pointer transition-all
                        ${isActive
                        ...
                        >
                          {slotImage ? (
                            ...
                            <span className="text-[10px] font-sans text-gray-400 text-center px-1">
                              {slot.label}
                            </span>
                          )}
                        </div>
              ...
              <FadeIn delay={0.1}>
                <div>
                  ...
                  {/* Quick Facts strip */}
                  <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 rounded-sm border border-gray-700 bg-white/10 backdrop-blur-sm px-4 py-3 text-xs font-sans text-gray-300">
                  ...
                  <div className="mt-5 flex flex-wrap gap-6 border-b border-gray-700 pb-5">
                  ...
                  <div className="mt-6 flex flex-col gap-2">
                    <Link to="/services">
                      <Button variant="premium" size="lg" className="w-full text-xs">
                        BOOK DIRECT
                      </Button>
                    </Link>
                  ...
                  <div className="mt-6 rounded-sm border border-gray-700 bg-white/5 p-4">
                    <h2 className="text-xs font-sans font-semibold uppercase tracking-widest text-gray-400 mb-3">Why this vehicle</h2>
            ...
            {/* Policies */}
            <FadeIn>
              <div className="mt-16 rounded border border-gray-700 bg-white p-8">
                ...
                <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  {policies.map((p) => (
                    <div key={p.label} className="flex gap-3">
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-sm bg-gold/10">
