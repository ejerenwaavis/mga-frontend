...
import { Tag, ArrowLeft, ShieldCheck, CreditCard, UserCheck } from "lucide-react";
...
export default function VehicleDetails() {
  ...
  return (
    <>
      {/* Dark background section at the top - this gives navbar something dark to sit on */}
      ...
      <section className="py-12 md:py-16">
        <div className="container">
            ...
            <FadeIn delay={0.1}>
              <div>
                ...
                <div className="mt-6 rounded-sm border border-border/60 bg-stone p-4">
                  <h2 className="mb-3 text-xs font-sans font-semibold uppercase tracking-widest text-muted-foreground">Why this vehicle</h2>
          ...
          {/* Policies */}
          <FadeIn>
            <div className="mt-16 rounded border border-border bg-stone p-8">
