...
const serviceTypes = [
  {
    ...
    description:
      "Convenient vehicle pickup and drop-off at HartsfieldΓÇôJackson Atlanta International Airport, designed for a fast and seamless arrival or departure.",
  },
  {
    id: "rentals",
    icon: Car,
...
export default function Contact() {
  ...
  <div className="space-y-8 h-full flex flex-col">
    ...
    {/* Map ΓÇö moved here from the standalone section below */}
    <div className="flex-1 min-h-64 w-full overflow-hidden rounded border border-border">
      <iframe
        ...
        title="Mead Green Autos ΓÇö Atlanta"
      />
    </div>
